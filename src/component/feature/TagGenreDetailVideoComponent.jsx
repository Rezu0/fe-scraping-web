    ...
    <>
      {
        isDataGenre?.map((item, index) => (
          <div 
            key={index}
            className="flex items-center gap-2 bg-adultdesu-navbartext text-xs text-white px-3 py-1 rounded-sm hover:bg-adultdesu-background-hover duration-300 cursor-pointer mx-1 mb-1"
          >
