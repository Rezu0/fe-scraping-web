      ...
      <div className="grid grid-cols-1 gap-4 text-end">
        <div className="flex justify-between p-2">
          ...
          <div className="relative inline-block">
            <div 
              className="bg-adultdesu-backgroundbox hover:bg-adutldesu-dark-hover text-adultdesu-navbartext inline-flex items-center gap-2 cursor-pointer p-2 mx-1 rounded-sm duration-300 transition-transform active:scale-75 select-none"
              onClick={() => toggleFilter('sort')}
            >
              <svg className="w-3 h-3 sm:h-4 sm:w-4 text-adultdesu-navbartext" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          <div className="relative inline-block">
            <div 
              className="bg-adultdesu-backgroundbox hover:bg-adutldesu-dark-hover text-adultdesu-navbartext inline-flex items-center gap-2 cursor-pointer p-2 mx-1 rounded-sm duration-300 transition active:scale-75 select-none"
              onClick={() => toggleFilter('genre')}
            >
              <svg className="w-3 h-3 sm:h-4 sm:w-4 text-adultdesu-navbartext" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
